		...
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "1.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
					<center><h4 style = "color:rgba(0, 255, 0, 1);">Standard</h4></center>
					<center><label>Small Size Bed</label> <label style = "color:red;"> 2,000.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "2.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
					<center><h4 style = "color:rgba(0, 255, 0, 1);">Extra Bed</h4></center>
					<center><label style = "color:red;"> 800.00</label></center>
				</div>
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "3.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<br />
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "4.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "5.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
				...
				<div style = "float:left; margin-left:40px; width:300px; height:300px; ">
					<center><img src = "6.jpg" width = "250px" height = "250px"  style = "margin-top:5px;"/></center>
